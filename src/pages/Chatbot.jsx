                                            ...
                                            <div className='flex gap-2'>
                                                {elem.error ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <div className='self-start py-4 px-3  max-w-[80%] bg-transparent  border border-white/[0.07] text-white text-sm rounded-md shrink-0 break-words overflow-x-auto'>
